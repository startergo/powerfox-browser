...
var gPowerFoxAutoRVManager = {
  ...
  _view: {
    ...
    getCellText: function (aRow, aColumn)
    {
      if (aColumn.id == "domainCol")
        return gPowerFoxAutoRVManager._AutoRVs[aRow].domain;
      else if (aColumn.id == "modeCol")
        return gPowerFoxAutoRVManager._modeToString(gPowerFoxAutoRVManager._AutoRVs[aRow].mode);
      return "";
    },
  ...
  init: function (aParams)
  {
    ...
    this._prefBranch = Services.prefs.getBranch(AUTORV_PREF_BRANCH);
    ...
    treecols.addEventListener("click", event => {
      ...
      gPowerFoxAutoRVManager.onAutoRVsort(sortField);
    });
  ...
  _loadAutoRVs: function ()
  {
    ...
    for (let domain of domains) {
      this._addAutoRVToList(domain, this._prefBranch.getCharPref(domain));
    }
...
{
  gPowerFoxAutoRVManager.init(aParams);
}
